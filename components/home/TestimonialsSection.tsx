...
const testimonials = [
  {
    quote: "Working with Conceptinero was a game-changer for our tech startup. They secured over $180,000 in SR&ED credits for us, which was critical for our R&D investments. Their process was smooth and their expertise was evident.",
    author: "Sarah Chen",
  ...
  {
    quote: "After struggling with SR&ED claims on our own for years, we brought in Conceptinero. They increased our claim amount by 43% and handled everything from documentation to CRA questions. I only wish we'd found them sooner.",
  ...
  {
    quote: "As a manufacturing company, we were skeptical about whether our innovations qualified for SR&ED. Conceptinero not only confirmed our eligibility but secured us a $245,000 tax credit. Their industry knowledge was impressive.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Success stories from companies that have trusted us with their SR&ED claims.
          </p>
        </motion.div>
