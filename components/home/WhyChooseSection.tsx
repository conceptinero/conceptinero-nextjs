...
const features = [
  {
    ...
    description: 'Work with one consultant from start to finish. No passing you around from person to person.'
  },
  {
    icon: ThumbsUp,
    title: 'Success Fee',
    description: 'Only pay when your claim is successful. No upfront costs or hidden fees.'
  },
  {
    icon: Target,
    title: '95% Success Rate',
    description: 'Our claims have a 94.25% approval rate, well above the industry average.'
  },
  {
    icon: Briefcase,
    title: 'Deep Industry Focus',
    description: 'Our consultants have technical backgrounds in the industries they serve.'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            We specialize in maximizing your SR&ED tax credits with a stress-free experience.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8">
            Unlike most consulting firms, we don't just advise – we handle the entire process, from identifying eligible activities to defending your claim if needed.
          </p>
