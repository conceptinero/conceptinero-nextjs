...
// Variable: postsQuery
// Query: *[_type == "post"] | order(publishedAt desc) {    _id,    title,    slug,    description,    featured,    readTime,    publishedAt,    mainImage{      asset->{        _id,        url      },      alt    },    author->{      _id,      name,      slug,      image{        asset->{          _id,          url        },        alt      }    },    categories[]->{      _id,      title,      slug    },    body  }
...
// Query: *[_type == "post" && slug.current == $slug][0] {    _id,    title,    slug,    description,    featured,    readTime,    publishedAt,    mainImage{      asset->{        _id,        url      },      alt    },    author->{      _id,      name,      slug,      image{        asset->{          _id,          url        },        alt      }    },    categories[]->{      _id,      title,      slug    },    body  }
...
// Query: *[_type == "post" && featured == true] | order(publishedAt desc) {    _id,    title,    slug,    description,    featured,    readTime,    publishedAt,    mainImage{      asset->{        _id,        url      },      alt    },    author->{      _id,      name,      slug,      image{        asset->{          _id,          url        },        alt      }    },    categories[]->{      _id,      title,      slug    },    body  }
...
// Query: *[_type == "author"] | order(name asc) {    _id,    name,    role,    slug,    image{      asset->{        _id,        url      },      alt    },    bio,    linkedin  }
